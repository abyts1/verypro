let count = 0;
var newriddle = document.createElement('p');
var randomRiddle;
...
function showMeme() {
    ...
    const randomMemeUrl = getRandomData("memes");
      ...
      document.getElementById('meme').appendChild(newimg);
      count++;
...
function showJoke() {
  ...
  const newmeme = document.createElement('p');
  document.getElementById('joke').appendChild(newmeme);
  newmeme.innerHTML = randomJokeText
}
...
function showQuote() {
  ...
  const newquote = document.createElement('quote');
  document.getElementById('quote').appendChild(newquote);
  newquote.innerHTML = (`quote: '${randomQuote.quote}', author: '${randomQuote.author}'`);
...
function showRiddle() {
  ...
  clearAll(4);
  var randomRiddle = getRandomData("riddles");

  document.getElementById('riddle').appendChild(newriddle)
  newriddle.innerHTML = "question: '" + randomRiddle.question + "', answer: '" + "'"
  newriddle.id = 'riddleshow'
  riddleans = randomRiddle.answer;
  riddleqn = randomRiddle.question
}
...
function revealAnswers() {
  ...
  if (document.getElementById('riddleshow') != undefined && alreadyrevealed == false) {
    document.getElementById('riddleshow').innerHTML = document.getElementById('riddleshow').innerHTML.slice(0, -1) + riddleans + document.getElementById('riddleshow').innerHTML.slice(-1);
    alreadyrevealed = true;
  }
  else if (document.getElementById('riddleshow') != undefined && alreadyrevealed == true) {
    document.getElementById('riddleshow').innerHTML = "question: '" + riddleqn + "', answer: '" + "'"
    console.log('toggled');
